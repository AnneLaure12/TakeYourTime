...
achievements_data = [ { date: "31/05/2019", mood: mood2, rating: 1, user: user2, exercice: exo6 },
                      { date: "01/06/2019", mood: mood3, rating: 0, user: user2, exercice: exo4 },
                      { date: "02/06/2019", mood: mood5, rating: 3, user: user2, exercice: exo13 },
                      { date: "03/06/2019", mood: mood4, rating: 3, user: user2, exercice: exo7 },
                      { date: "04/06/2019", mood: mood2, rating: 2, user: user2, exercice: exo11 },
                      { date: "05/06/2019", mood: mood6, rating: 3, user: user2, exercice: exo16 },
                      { date: "06/06/2019", mood: mood7, rating: 4, user: user2, exercice: exo5 }
                    ]
